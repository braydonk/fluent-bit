...
{
    /**
     * TZ=EST5EDT date -d @1697533200
     * Tue Oct 17 05:00:00 AM EDT 2023
     * 
     * TZ=GMT date -d @1697533200
     * Tue Oct 17 09:00:00 AM GMT 2023
     */
    test_parser_timestamp_timezone("EST5EDT", /* char *tz */
                                   "%Y-%m-%d:%H:%M:%S", /* char *time_fmt */ 
                                   "2023-10-17:05:00:00", /* char *timestamp */
                                   "1697533200", /* char *expected_epoch */
                                   FLB_TRUE); /* int use_system_timezone */
}

void flb_test_filter_parser_use_system_timezone_find_dst()
{
    /**
     * TZ=MST7MDT date -d @1699732800
     * Sat Nov 11 01:00:00 PM MST 2023 
     * 
     * TZ=GMT date -d @1699732800
     * Sat Nov 11 08:00:00 PM GMT 2023
    */
    test_parser_timestamp_timezone("MST7MDT", /* char *tz */
                                   "%Y-%m-%d:%H:%M:%S", /* char *time_fmt */ 
                                   "2023-11-11:13:00:00", /* char *timestamp */
...
TEST_LIST = {
    ...
    {"filter_parser_use_system_timezone_find_dst",flb_test_filter_parser_use_system_timezone_find_dst },
